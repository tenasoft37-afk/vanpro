                ...
                <div className="bg-[#fbbf24] rounded-3xl p-8 md:p-16 flex flex-col shadow-lg text-center md:text-left">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between w-full mb-10">
                        ...
                        <div className="w-full md:w-1/2 md:pl-10">
                            <form className="flex flex-col sm:flex-row gap-4 sm:gap-0 sm:overflow-hidden bg-transparent sm:bg-white rounded-lg sm:h-14">
                                <input
                                    type="email"
                                    placeholder="Your mail address"
                                    required
                                    className="w-full sm:flex-1 px-6 py-4 sm:py-0 text-gray-700 placeholder-gray-400 focus:outline-none h-14 sm:h-full rounded-lg sm:rounded-none bg-white"
                                />
                                <button
                                    type="submit"
                                    className="w-full sm:w-auto bg-[#00bfff] hover:bg-[#00a3d9] text-white font-bold px-8 py-4 sm:py-0 h-14 sm:h-full transition-colors duration-300 rounded-lg sm:rounded-none"
                                >
                                    Subscribe
                                </button>
                            </form>
